...
export const queryGPTFirstMessage = async (message) => {
    const KEY_GPT = process.env.KEY_GPT
    const MAXCHARACTERS = 100
    const MODEL = 'gpt-3.5-turbo'
    const API_URL = 'https://api.openai.com/v1/chat/completions'
    ...
    const prompt = `Imagina que eres un usuario del chat. Otro usuario ha escrito su primer mensaje, dale la bienbenida al canal con un mensaje que le anime a seguir viendo el directo. El contexto del chat es temática de videojuegos. Máximo ${MAXCHARACTERS} caracteres.`
